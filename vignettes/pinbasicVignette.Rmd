---
title: "pinbasic: R Package for Fast and Stable Estimation of Static Models for the Probability of Informed Trading"
...
vignette: >
  %\VignetteIndexEntry{pinbasic: R Package for Fast and Stable Estimation of Static Models for the Probability of Informed Trading}
...
\newcommand{\thetaeho}{\theta_{\text{ext}} = \left(\probinfevent, \probbadnews,\intensuninfbuys, \intensuninfsells, \intensinf \right)}
\newcommand{\thetaehoshort}{\theta_{\text{ext}}}
...
\newcommand{\thetaeho}{\theta_{\text{ext}} = \left(\probinfevent, \probbadnews, \intensuninfbuys, \intensuninfsells, \intensinf \right)}
\newcommand{\thetaehoshort}{\theta_{\text{ext}}}
\newcommand{\thetaehoinishort}{\theta_{\text{ext}}^0}
...
```{r intro, child = "GenAssumptions.Rmd"}
```

```{r static, child = "staticPINmodels/StaticModels.Rmd"}
```

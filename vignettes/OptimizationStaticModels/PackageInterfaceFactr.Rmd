...
```{r insert-pin_ll, echo=FALSE, cache = FALSE}
insert_fun('pin_ll')
...
For the `factorization` argument the user can choose between `"Lin\_Ke"` and `"EHO"` strings.
...
strings `"alpha"`, `"delta"`, `"epsilon\_b"`, `"epsilon\_s"` and `"mu"` (in this order).

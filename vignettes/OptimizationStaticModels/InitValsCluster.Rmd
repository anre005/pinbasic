...
e.g. if quarterly data is used to estimate the probability of informed trading
around 60 clusters exist when the algorithm is initialized.
...
The definition of *shortest distance* distinguish between the

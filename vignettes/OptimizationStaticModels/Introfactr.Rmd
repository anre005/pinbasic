...
Computation of equations \\ref{eq:loglikelihoodEKOPconcrete} and \\ref{eq:loglikelihoodEHOconcrete} often fails
...
However, for any recent data with number of daily buys and sells often higher than \num{1000} shares,

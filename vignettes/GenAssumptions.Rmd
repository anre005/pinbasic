...
Market participants can be splitted in two disjoint groups, informed and uninformed traders.
...
<!-- \begin{figure} -->
<!--   \centering -->
<!--   \includegraphics{tikzfigs/Pinframenew.tikz} -->
<!--   \caption{Distribution of transactions on trading days with respect to the different days' conditions.} -->
<!--   \label{fig:trading} -->
<!-- \end{figure} -->
<!-- % -->
...
\begin{align}
\label{eq:pingeneral}
\pintext = \dfrac{\text{Expected number of information-based transactions}}{\text{Expected number of total transactions}}
\end{align}
$$
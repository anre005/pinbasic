...
#' @param lower \emph{numeric} lower bounds for optimization
#' @param upper \emph{numeric} upper bounds for optimization
#' @param num_best_res Results of how many optimizations should be returned? Either numeric or 'all',
#'                     only relevant if \code{init_vals} = 'Grid', defaults to 1
#' @param only_converged \emph{logical} Should only results for which the likelihood converged be returned?
...
#' @examples
#' data("BSfrequent")
#' inits_grid <- initial_vals(numbuys = BSfrequent[,"Buys"], numsells = BSfrequent[,"Sells"],
#'                           method = "Grid")
#'
#' inits_hac <- initial_vals(numbuys = BSfrequent[,"Buys"], numsells = BSfrequent[,"Sells"],
#'                           method = "HAC")
#'
#' inits_hac_ref <- initial_vals(numbuys = BSfrequent[,"Buys"], numsells = BSfrequent[,"Sells"],
#'                               method = "HAC_Ref")
#'
#' pin_est_core(numbuys = BSfrequent[,"Buys"], numsells = BSfrequent[,"Sells"],
